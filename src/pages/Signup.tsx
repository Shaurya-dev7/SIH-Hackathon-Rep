...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowLeft, Wrench, Loader2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Back to Home */}
        <Link to="/" className="inline-flex items-center text-white hover:text-white/80 mb-8 transition-smooth">
        ...
        <Card className="bg-background/95 backdrop-blur-md shadow-card-hover border-border">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-muted-foreground">
              Join thousands of customers who trust us with their appliance repairs
            </CardDescription>
          </CardHeader>
        ...
        <div className="mt-8 text-center text-white/80 text-sm">
          ...
          <p className="mt-2">Join 10,000+ happy customers today</p>
        </div>
      </div>
    </div>
  );
